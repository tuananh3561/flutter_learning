...
abstract class $LoginRequestModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String phoneNumber, String password, String deviceId});
}
...
class _$LoginRequestModelImpl implements _LoginRequestModel {
  ...
  @override
  String toString() {
    return 'LoginRequestModel(phoneNumber: $phoneNumber, password: $password, deviceId: $deviceId)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, phoneNumber, password, deviceId);
...
abstract class _LoginRequestModel implements LoginRequestModel {
  const factory _LoginRequestModel(
      ...
      required final String deviceId}) = _$LoginRequestModelImpl;
