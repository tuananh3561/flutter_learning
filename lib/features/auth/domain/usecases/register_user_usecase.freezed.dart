...
class _$RegisterParamsImpl implements _RegisterParams {
  ...
  @override
  String toString() {
    return 'RegisterParams(phone: $phone, password: $password, name: $name, deviceId: $deviceId, deviceModel: $deviceModel, deviceType: $deviceType)';
  }
...
abstract class _RegisterParams implements RegisterParams {
  const factory _RegisterParams(
      ...
      final String? deviceModel,
      final String? deviceType}) = _$RegisterParamsImpl;
