...
class ThemeConstants {
  ...
  static const Color primaryBlue = Color(0xFF1A237E); // Dark Blue for night theme
  static const Color accentYellow = Color(0xFFFFD54F); // Amber for stars/highlights
  ...
  static const Color backgroundDark = Color(0xFF121212); // Dark background for night mode
  ...
  // Text Colors
  static const Color textDark = Color(0xFF212121); // Primary text on light background
  static const Color textLight = Color(0xFFF5F5F5); // Primary text on dark background
  static const Color textSecondaryDark = Color(0xFF757575); // Secondary text on light background
  static const Color textSecondaryLight = Color(0xFFBDBDBD); // Secondary text on dark background
